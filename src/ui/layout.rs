...
use crate::ui::components::{
    connection_details::render_connection_details, history::render_history, search_input::render_search_input,
...
use crate::ui::utils::center_rect_at_least;
...
pub fn draw(f: &mut Frame, app: &App) {
    ...
    if app.show_help_modal {
        let base_area = center_rect_at_least(60, 75, 54, 18, f.area());
